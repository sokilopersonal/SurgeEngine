...
namespace UnityEngine.Rendering.HighDefinition
{
    ...
    class HDRenderPipelineRuntimeShaders : IRenderPipelineResources
    {
        ...
        [SerializeField, ResourcePath("Runtime/Sky/ColorSky/ColorSky.shader")]
        private Shader m_ColorSkyPS;

        public Shader colorSkyPS
        {
            get => m_ColorSkyPS;
            set => this.SetValueAndNotify(ref m_ColorSkyPS, value);
        }
