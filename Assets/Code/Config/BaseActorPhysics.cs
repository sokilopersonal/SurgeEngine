...
[CreateAssetMenu(fileName = "BaseActorPhysics", menuName = "SurgeEngine/Configs/Physics/Base")]
public class BaseActorPhysics : ScriptableObject
{
    [Header("Cast")]
