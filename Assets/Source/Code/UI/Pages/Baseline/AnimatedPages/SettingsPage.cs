...
using System.Linq;
using DG.Tweening;
using SurgeEngine.Source.Code.Infrastructure.Tools.Managers.UI;
using UnityEngine;
using UnityEngine.InputSystem;
using UnityEngine.UI;

namespace SurgeEngine.Source.Code.UI.Pages.Baseline.AnimatedPages
{
    public class SettingsPage : Page
    {
        ...
        protected override void Show()
        {
            ...
            _currentSubPage = 0;
            if (background) sequence.Join(background.DOFade(0f, enterDuration));
        }
        ...
        protected override void Hide()
        {
            ...
            if (background) sequence.Join(background.DOFade(1f, exitDuration));
            _current = null;
