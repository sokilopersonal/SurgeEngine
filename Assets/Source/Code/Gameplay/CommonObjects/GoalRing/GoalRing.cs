...
using SurgeEngine.Source.Code.Gameplay.UI;
...
namespace SurgeEngine.Source.Code.Gameplay.CommonObjects.GoalRing
{
    public class GoalRing : StageObject
    {
        ...
        public override void OnEnter(Collider msg, CharacterBase context)
        {
            if (!_triggered)
            {
                ...
                context.Flags.AddFlag(new AutorunFlag(FlagType.Autorun, 1f, 0f, 0.2f));
