...
namespace SurgeEngine.Source.Code.Core.Character.States
{
    public class FStateSkydive : FCharacterState, IDamageableState, IPointMarkerLoader
    {
        ...
        public override void OnEnter()
        {
            ...
            Character.Flags.AddFlag(FlagType.Skydiving);
        ...
        public override void OnTick(float dt)
        {
            ...
            Animator.SetFloat("Skydive", Character.Input.MoveVector.x, 0.5f, dt);
        }
        ...
        public override void OnFixedTick(float dt)
        {
            ...
            if (air)
            {
                ...
                vel.y = 0;
                Model.RotateBody(vel, 7.5f);

                if (Mode.ModeSide != null && Kinematics.GetAttachState())
                {
                    var path = Mode.SideSplineData;
